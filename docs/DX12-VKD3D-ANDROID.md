...
ни в одной сборке этого APK**, и это не «недоделано по лени», а следствие четырёх независимых
...
Что реально делает этот путь лучше — то же самое исследование, но внутри Vulkan: очередь выдачи
кадров, третье изображение в свопчейне и разбор того, что стоит и не стоит переносить из
D3D12-ветки — в [ANDROID-VULKAN-TUNING.md](ANDROID-VULKAN-TUNING.md).
